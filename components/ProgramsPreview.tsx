      ...
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {programs.map((program) => (
            <Card
              key={program.id}
              className="group overflow-hidden p-0 border-0 shadow-soft hover:shadow-soft-lg transition-all duration-300 hover:-translate-y-2 rounded-2xl"
            >
              <div className="relative h-56 overflow-hidden">
                <Image
                  ...
                  priority={program.id === 'infant'}
                />

                <Badge className="absolute bottom-4 left-4 bg-accent text-navy px-4 py-2 text-sm font-bold">
                  {program.age}
                </Badge>
              </div>
              ...
              <CardContent className="p-6 pt-3">
                ...
                <Button
                  variant="link"
                  asChild
                  className="p-0 h-auto text-navy font-bold hover:text-pink"
                >
